...
namespace TrackIt.Infraestructure.Database.Migrations
{
    ...
    [Migration("20241023001050_Insert_Values_Categories_And_PaymentFormats")]
    partial class Insert_Values_Categories_And_PaymentFormats
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TrackIt.Entities.Expenses.CategoryConfig", b =>
                {
                    b.HasOne("TrackIt.Entities.Expenses.Category", "Category")
                        .WithOne("CategoryConfig")
                        .HasForeignKey("TrackIt.Entities.Expenses.CategoryConfig", "CategoryId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("TrackIt.Entities.Expenses.PaymentFormatConfig", b =>
                {
                    b.HasOne("TrackIt.Entities.Expenses.PaymentFormat", "PaymentFormat")
                        .WithOne("PaymentFormatConfig")
                        .HasForeignKey("TrackIt.Entities.Expenses.PaymentFormatConfig", "PaymentFormatId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("TrackIt.Entities.Expenses.Category", b =>
                {
                    b.Navigation("CategoryConfig");
                });

            modelBuilder.Entity("TrackIt.Entities.Expenses.PaymentFormat", b =>
                {
                    b.Navigation("PaymentFormatConfig");
                });
